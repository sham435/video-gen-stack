...
export class SoundFX {
  ...
  generateBreakingImpact(outPath) {
    const args = [
      '-y',
      '-f', 'lavfi', '-i', 'sine=f=80:r=48000:duration=0.4,afade=t=out:st=0.3:d=0.1,volume=1.2',
    ...
    try { execFileSync('ffmpeg', args, { stdio: 'pipe', timeout: 10000 }) } catch {}
    return outPath
  }
  ...
  generateTransitionWhoosh(outPath, type = 'fast') {
    ...
    const args = [
      '-y',
      '-f', 'lavfi', '-i', `anoisesrc=d=${dur}:c=brown:a=0.2:r=48000,afade=t=in:st=0:d=0.02,afade=t=out:st=${dur - 0.05}:d=${dur * 0.3},volume=0.25`,
      '-c:a', 'mp3', outPath,
    ]
    try { execFileSync('ffmpeg', args, { stdio: 'pipe', timeout: 10000 }) } catch {}
    return outPath
  ...
  generateAlertPing(outPath) {
    const args = [
      '-y',
      '-f', 'lavfi', '-i', 'sine=f=880:r=48000:duration=0.15,afade=t=out:st=0.1:d=0.05,volume=0.5',
      '-f', 'lavfi', '-i', 'sine=f=1320:r=48000:duration=0.15,afade=t=in:st=0:d=0.01,afade=t=out:st=0.1:d=0.05,volume=0.3',
